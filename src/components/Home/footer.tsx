    ...
    <section className="">
      <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        ...
        <p className="mt-8 text-base leading-6 text-center text-gray-400">
          &copy; 2025 Designed by AmenAllah Mselmi{" "}
          <a href="https://www.linkedin.com/in/amen-allah-mselmi-294171241/" className="inline-block ml-2 text-gray-400 hover:text-gray-500">
            <svg
